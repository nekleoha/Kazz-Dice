...
<img src="docs/screen/deff_screen.png" width="420">

Выбор окна вероятности и ставки, история последних раундов сверху. Ниже — переключение объёма между Base, Boost и Super Boost.

### Run — лестница с фиксацией

<img src="docs/screen/run_screen.png" width="420">

Множитель накапливается с каждым попаданием, Cash Out доступен до следующего броска — решение принимается на каждом шаге.

### Bullseye — бонусный режим

<img src="docs/screen/bonus_screen.png" width="420">

Серия из 25 бросков по мишени: близость к центру определяет множитель.
